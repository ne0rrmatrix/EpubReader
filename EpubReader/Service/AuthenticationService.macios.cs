...
public partial class AuthenticationService
{
	public Task<string> SignInWithGooglePlatformAsync(CancellationToken cancellationToken)
	{
		...
		Trace.TraceWarning("Google sign-in on iOS/MacCatalyst is intentionally blocked until GoogleService-Info.plist is added and native Firebase configuration is completed.");
